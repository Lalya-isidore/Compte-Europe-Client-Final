...
try {
    ...
    if ($data) {
        ...
        $sql = "INSERT INTO transfers (paypal_email, reason, user_id, solidvire, devise, token, status, created_at, updated_at) 
                VALUES (:paypalEmail, :reasonPaypal, :user_id, :solidvire, :devise, :token, :status, :created_at, :updated_at)";
        $stmt = $db->prepare($sql);
