            ...
            <div class="modal-body">
                <div class="card mt-4 shadow">
                    <div class="card-body bg-light">
                        <small><strong>PayPal email address:</strong> <?php echo htmlspecialchars($paypalEmail); ?></small><br>
                        <small><strong>Reason for PayPal Transfer:</strong> <?php echo htmlspecialchars($reasonPaypal); ?></small><br>
                        <p class="text-center">
                            <?php
...
<div class="dashboard ">
    <div class="row">
        ...
        <div class="col-md-10 mt-4">
            <a href="index.php?page=show" class="btn btn-primary my-3"> Back </a>
            ...
            <h3 class="mt-5 text-center">Virement en cours, veuillez patienter...</h3>
    ...
    var interval = setInterval(function() {
        if (width >= 100) {
            ...
            if (accountBalance > 0) {
                ...
                var transferData = {
                    paypalEmail: '<?php echo $paypalEmail; ?>',
                    reasonPaypal: '<?php echo $reasonPaypal; ?>',
