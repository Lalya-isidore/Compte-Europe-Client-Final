                ...
                <div class="row g-4 justify-content-center">
                    <div class="col-12 col-lg-7 animate-in">
                        <div class="summary-card">
                            <h2><i class="fab fa-paypal text-primary me-2"></i><?php echo $success_message_display; ?></h2>
                                <p class="mb-4 text-secondary"><?php echo htmlspecialchars($success_message_text_raw, ENT_QUOTES, 'UTF-8'); ?></p>
